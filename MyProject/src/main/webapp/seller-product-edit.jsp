							...
							<div class="row">
								<div class="col-md-12">
									<div class="aa-contact-address-left">
										...
										%>
										<form class="comments-form contact-form" action="ProductController"
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<input type="text" value="<%=p.getProduct_name() %>"
															class="form-control" name="product_name">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<input type="text" value="<%=p.getProduct_price() %>"
												...
												<div class="col-md-6">
													<div class="form-group">
														<textarea class="form-control" rows="3"
															placeholder="Product Description" name="product_desc"><%=p.getProduct_desc() %></textarea>
													</div>
												</div>
											</div>
